...
/*
 * @Author @Lijian
 * @Description //这个类就是用来创建一个查询条件的，写了一大堆的方法，用来添加各种条件
 * 总共就三个属性，orderByClause用来排序，distinct表示是否去重，oredCriteria表示的是查询条件
...
public class SysMenuExample {
    ...
    /*
     * @Author @Lijian
     * @Description //无参构造方法，就是创建一个空的查询条件
     * @Date 2023/12/7 16:04
     * @return
     **/
    ...
    /*
     * @Author @Lijian
     * @Description 这个方法就是设置排序的条件，orderByClause就是排序的条件，比如age desc
     * @Date 2023/12/7 16:04
     * @return
     **/
    ...
    /*
     * @Author @Lijian
     * @Description //创建一个Criteria对象，这个对象就是用来添加条件的
     * @Date     2023/12/7 16:04
     * @return
     **/
    ...
    /**
     * @Author @Lijian
     * @Description //这个方法是创建一个新的Criteria对象
     * @Date 2023/12/7 16:04
     * @return
     **/
    ...
    /**
     * @Author @Lijian
     * @Description //查询条件对象的抽象父类，里面就是一个List<Criterion>，用来存放条件
     * 里面封装好了一堆的方法，用来添加各种条件，这样有的子类就不用写了
     * @Date 2023/12/7 16:04
     * @return
     **/
    protected abstract static class GeneratedCriteria {
        ...
        /*
         * @Author @Lijian
         * @Description 这个方法就是向criteria中添加一个条件，这个条件是condition--->value,
         * 比如condition是age<，value是18，那么就是添加一个age<18的条件
         * 而property表示的是属性名称，比如age，用于在value为null时抛出异常
         * @Date 2023 12 7
         * @return
         **/
    ...
    /**
     * @Author @Lijian
     * @Description //这个类主要是用来封装查询条件的，像什么模糊查询，大于小于等等
     * @Date 2020/3/20 0020 10:58
     * @return
     **/
